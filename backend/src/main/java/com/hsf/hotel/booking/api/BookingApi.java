...
import com.hsf.hotel.booking.dto.BookingMapper;
...
public class BookingApi {
    ...
    private final com.hsf.hotel.common.service.InvoiceService invoiceService;
    private final com.hsf.hotel.payment.repository.PaymentRepository paymentRepository;
    private final VoucherService voucherService;
    private final AuditLogService auditLogService;
    private final BookingMapper bookingMapper;

    public BookingApi(BookingService bookingService, RoomService roomService,
                      com.hsf.hotel.common.service.InvoiceService invoiceService,
                      com.hsf.hotel.payment.repository.PaymentRepository paymentRepository,
    ...
    public ResponseEntity<byte[]> downloadInvoice(@PathVariable Integer id, HttpSession session) {
        ...
        List<com.hsf.hotel.payment.model.Payment> payments = paymentRepository.findByBookingIdOrderByCreatedAtDesc(id);
    ...
    public ResponseEntity<ApiResponse<?>> validateVoucher(
        ...
        if (res.voucher != null) {
            ...
            com.hsf.hotel.promotion.model.Promotion p = res.promotion;
