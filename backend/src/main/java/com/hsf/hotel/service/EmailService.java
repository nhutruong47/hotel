...
public class EmailService {
    ...
    public void sendVerificationEmail(com.hsf.hotel.model.User user) {
        throw new UnsupportedOperationException("Use sendVerificationEmail(user, rawToken)");
    }

    public void sendVerificationEmail(com.hsf.hotel.model.User user, String rawToken) {
    ...
    public void sendPasswordResetEmail(com.hsf.hotel.model.User user) {
        throw new UnsupportedOperationException("Use sendPasswordResetEmail(user, rawToken)");
    }

    public void sendPasswordResetEmail(com.hsf.hotel.model.User user, String rawToken) {
    ...
    public void sendNewBookingNotificationToAdmin(com.hsf.hotel.model.Booking booking, String adminEmail) {
    ...
    public void sendBookingApprovedEmail(com.hsf.hotel.model.Booking booking) {
    ...
    public void sendBookingRejectedEmail(com.hsf.hotel.model.Booking booking) {
    ...
    public void sendBookingCancelledEmail(com.hsf.hotel.model.Booking booking) {
        sendBookingCancelledEmail(booking, "Đã hủy đặt phòng");
    }

    public void sendBookingCancelledEmail(com.hsf.hotel.model.Booking booking, String reason) {
    ...
    public void sendBookingExpiredEmail(com.hsf.hotel.model.Booking booking) {
    ...
    public void sendNoShowNotificationEmail(com.hsf.hotel.model.Booking booking) {
    ...
    public void sendPaymentConfirmedToCustomer(com.hsf.hotel.model.Booking booking) {
        String bookingLink = baseUrl + "/account/bookings/" + booking.getId();
    ...
    public void sendPaymentReceivedNotificationToAdmin(com.hsf.hotel.model.Booking booking, String adminEmail) {
        String adminLink = baseUrl + "/admin/bookings/" + booking.getId();
    ...
    private String buildCancellationIntro(String cancelledBy, String reason, com.hsf.hotel.model.Booking booking) {
        String intro;
    ...
    private String buildRefundInfo(com.hsf.hotel.model.Booking booking) {
