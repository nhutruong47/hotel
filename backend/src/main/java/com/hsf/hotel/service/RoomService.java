...
public class RoomService {
    ...
    public List<Room> searchRooms(LocalDate checkIn, LocalDate checkOut, BigDecimal minPrice,
        ...
        org.springframework.data.jpa.domain.Specification<Room> spec = org.springframework.data.jpa.domain.Specification
            .where(com.hsf.hotel.repository.RoomSpecification.isAvailable())
            .and(com.hsf.hotel.repository.RoomSpecification.priceBetween(minPrice, maxPrice))
            .and(com.hsf.hotel.repository.RoomSpecification.hasRoomType(roomTypeId))
            .and(com.hsf.hotel.repository.RoomSpecification.hasCapacityGreaterThanEqual(capacity))
            .and(com.hsf.hotel.repository.RoomSpecification.hasBedroomsGreaterThanEqual(bedrooms))
            .and(com.hsf.hotel.repository.RoomSpecification.hasAmenities(amenities))
            .and(com.hsf.hotel.repository.RoomSpecification.isNotBooked(checkIn, checkOut))
            .and(com.hsf.hotel.repository.RoomSpecification.hasPromotion(promotion));
