...
import com.hsf.hotel.model.NotificationType;
...
public class BookingService {
    ...
    public Booking createBooking(User user, Room room, LocalDate checkIn, LocalDate checkOut,
        ...
        if (voucherCode != null && !voucherCode.trim().isEmpty()) {
            ...
            if (vres.voucher != null) {
                ...
                com.hsf.hotel.model.Promotion p = vres.promotion;
        ...
        emailService.sendNewBookingNotificationToAdmin(saved, adminEmail);
        return saved;
    }
    ...
    public Booking rejectBooking(Integer bookingId, User adminUser, String reason) {
        ...
        emailService.sendBookingRejectedEmail(saved);
        return saved;
    }
    ...
    public Booking confirmPayment(Integer bookingId, String transactionRef, BigDecimal amount) {
        ...
        emailService.sendPaymentReceivedNotificationToAdmin(saved, adminEmail);
        return saved;
    }
    ...
    private void recordTransition(Booking booking, BookingStatus from, BookingStatus to, User user, String reason) {
        ...
        if (to != null && notificationService != null) {
            ...
            if (to == BookingStatus.PENDING_PAYMENT) {
                ...
                // Email confirmation goes to the customer — the in-app banner is
                // not the primary channel for a payment event.
                ...
                if (emailService != null) {
                    emailService.sendBookingCancelledEmail(booking,
                            reason != null ? reason : "Cancelled by system");
                }
                ...
                if (emailService != null) {
                    emailService.sendNoShowNotificationEmail(booking);
                }
