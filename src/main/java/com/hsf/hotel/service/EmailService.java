...
public class EmailService {
    ...
    public void sendPasswordResetEmail(User user) {
        if (mailSender == null) {
            System.out.println("📧 [DEMO] Password reset email for: " + user.getEmail());
            System.out.println("📧 [DEMO] Reset Link: " + baseUrl + "/reset-password?token=" + user.getResetToken());
            return;
        }
        ...
        try {
            Context context = new Context();
            context.setVariable("user", user);
            context.setVariable("resetLink", baseUrl + "/reset-password?token=" + user.getResetToken());
